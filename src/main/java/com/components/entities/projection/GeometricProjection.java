...
@Entity
@Table(name="geometric_projection")
@Getter
@Setter
public class GeometricProjection implements Serializable{

	private static final long serialVersionUID = 5001476529502369891L;
